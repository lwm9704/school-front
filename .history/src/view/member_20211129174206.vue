      ...
      this.$refs[this.memberForm].validate((valid) => {
        if (valid) {
          ...
          if (this.dialogInfo.type === "editMember") {
            if(this.memberForm.type === '外公'){
              this.memberForm.type = 0;
            }
            if(this.memberForm.type === '外婆'){
              this.memberForm.type = 1;
            }
            if(this.memberForm.type === '爷爷'){
              this.memberForm.type = 2;
            }
            if(this.memberForm.type === '奶奶'){
              this.memberForm.type = 3;
            }
            if(this.memberForm.sex === '男'){
              this.memberForm.sex = 0;
            }
            if(this.memberForm.sex === '女'){
