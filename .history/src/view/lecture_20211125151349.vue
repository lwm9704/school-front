<template>
  <div>
    ...
    >
      ...
      <el-table-column label="课程名称" prop="courseName" width="300" height="200" align="center"></el-table-column>
      <el-table-column label="老师名称" prop="teacherName" width="300" align="center"></el-table-column>
