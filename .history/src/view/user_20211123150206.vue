    ...
    <div class="dialog-form-account">
      ...
      <el-dialog title="学生信息" :visible.sync="studentFormVisible">
        <el-form :model="studentForm" :rules="studentRules" :ref="studentForm">
          ...
          <el-form-item label="联系人" prop="concats" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.concats"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="联系人电话" prop="cPhone" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.cPhone"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="家庭地址" prop="hAddress" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.hAddress"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="家庭邮编" prop="postCode" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.postCode"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="家庭状况" prop="hState" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.hState"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="父亲姓名" prop="fName" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.fName"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="父亲电话" prop="fPhone" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.fPhone"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="母亲姓名" prop="mName" :label-width="formLabelWidth">
            <el-input
              v-model="studentForm.mName"
              autocomplete="off"
            ></el-input>
          </el-form-item>
          <el-form-item label="母亲电话" prop="mPhone" :label-width="formLabelWidth">
            <el-input
