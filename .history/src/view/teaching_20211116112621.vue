    ...
    <el-dialog :title="dialogInfo.title" :visible.sync="teachingFormVisible">
      <el-form :model="teacheingForm">
        <el-form-item label="班级名称" :label-width="formLabelWidth">
          <el-select
            v-model="teacheingForm.classesName"
            clearable
            placeholder="请选择"
          >
            <el-option
        ...
        <el-form-item label="课程名称" :label-width="formLabelWidth">
          <el-select
            v-model="teacheingForm.courseName"
            clearable
            placeholder="请选择"
          >
            <el-option
        ...
        <el-form-item label="老师名称" :label-width="formLabelWidth">
          <el-select
            v-model="teacheingForm.teacherName"
            clearable
            placeholder="请选择"
          >
            <el-option
        ...
        <el-form-item label="学期" :label-width="formLabelWidth">
          <el-select
            v-model="teacheingForm.semester"
            clearable
            placeholder="请选择"
          >
            <el-option
