<template>
  <div>
    ...
    <el-dialog :title="dialogInfo.title" :visible.sync="teachingFormVisible">
      <el-form :model="teacheingForm">
        <el-form-item label="班级名称" :label-width="formLabelWidth">
          <el-select v-model="teacheingForm.classesName" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="课程名称" :label-width="formLabelWidth">
          <el-select v-model="teacheingForm.courseName" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="老师名称" :label-width="formLabelWidth">
          <el-select v-model="teacheingForm.teacherName" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="年份" :label-width="formLabelWidth">
          <el-input v-model="teacheingForm.year" autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item label="学期" :label-width="formLabelWidth">
          <el-select v-model="teacheingForm.semester" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="状态" :label-width="formLabelWidth">
          <el-select v-model="teacheingForm.state" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="备注" :label-width="formLabelWidth">
          <el-input v-model="teacheingForm.mark" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="teachingFormVisible = false">取 消</el-button>
