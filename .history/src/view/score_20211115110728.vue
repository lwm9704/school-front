<template>
  <div>
    <div class="main-head" :model="search">
      ...
      <dl>
        <dd>
          <el-input v-model="search.studentNo" placeholder="学生学号" clearable></el-input>
        </dd>
      </dl>
      <dl>
        <dd>
      ...
      <dl>
        <dd>
          <el-button type="primary" @click="deletedScoreList">删除所选</el-button>
        </dd>
      </dl>
    </div>
    ...
    >
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="deleteScore(scope.row)">删除</el-button>
          <el-button size="mini" @click="scoreEdit(scope.row)">修改信息</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="dialogInfo.title" :visible.sync="scoreFormVisible">
      <el-form :model="scoreForm">
        <el-form-item label="课程名称" :label-width="formLabelWidth">
          <el-select v-model="scoreForm.courseName" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="学生" :label-width="formLabelWidth">
          <el-select v-model="scoreForm.studentName" clearable placeholder="请选择">
            <el-option
        ...
        <el-form-item label="学期" :label-width="formLabelWidth">
          <el-select v-model="scoreForm.semester" clearable placeholder="请选择">
            <el-option
