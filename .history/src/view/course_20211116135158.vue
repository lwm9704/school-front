      ...
      <el-form :model="courseForm" :rules="courseRules">
        ...
        <el-col span="24">
          <el-form-item label="备注" :label-width="formLabelWidth">
            <el-input v-model="courseForm.mark" autocomplete="off" autosize type="textarea" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="courseFormVisible = false">取 消</el-button>
        <el-button type="primary" @click="courseFormVisible = false"
          >确 定</el-button
        >
      </div>
    </el-dialog>
