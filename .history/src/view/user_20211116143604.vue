  ...
  <div>
    ...
    <div class="dialog-form-account">
      <el-dialog title="新增用户" :visible.sync="userFormVisible">
        <el-form :model="userForm" :rules="userRules">
          ...
          <el-form-item label="密码" :label-width="formLabelWidth">
            <el-input v-model="userForm.pwd" autocomplete="off" show-password></el-input>
          </el-form-item>
      ...
      <el-dialog title="学生信息" :visible.sync="studentFormVisible">
        <el-form :model="studentForm" :rules="studentRules">
      ...
      <el-dialog title="老师信息" :visible.sync="teacherFormVisible">
        <el-form :model="teacherForm" :rules="teacherRules">
          <el-form-item label="姓名" :label-width="formLabelWidth">
