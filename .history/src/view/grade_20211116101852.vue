<template>
  <div>
    <div class="main-head" :model="search">
      <dl>
        <dd>
          <el-input v-model="search.headmasterName" placeholder="班主任姓名" clearable></el-input>
        </dd>
      </dl>
      <dl>
        <dd>
      ...
      <dl>
        <dd>
          <el-button type="primary" @click="deletedGradeList">删除所选班级</el-button>
        </dd>
      </dl>
    </div>
    ...
    >
      ...
      <el-table-column label="班级名称" prop="classesName" width="120"></el-table-column>
      <el-table-column label="班级人数" prop="classesNumber" width="120"></el-table-column>
      <el-table-column label="班主任" prop="teacherName" width="120"></el-table-column>

      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="headmasterEdit(scope.row)">安排班主任</el-button>
          <el-button size="mini" @click="teacheringEdit(scope.row)">安排任课老师</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="pageInfo.title" :visible.sync="gradeFormVisible">
      <el-form :model="gradeForm" :rules="gradeRules"> 
        ...
        <el-form-item label="班主任" :label-width="formLabelWidth">
          <el-select v-model="gradeForm.headmaster" clearable placeholder="请选择">
            <el-option
