  ...
  methods: {
    ...
    saveUserForm() {
      ...
      if (this.dialogInfo.type === "addUser") {
        ...
        if(this.userForm.role === 'manager'|| this.userForm.role === 'schoolmaster'){
          this.userFormVisible = false;
          req('insertUser',{...this.userForm}).then(
        ...
        if (this.userForm.role === "teacher"|| this.userForm.role === 'assistant') {
