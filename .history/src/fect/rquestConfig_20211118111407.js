...
const urlHead = 'http://localhost:9000'
const qs = require('qs')
...
const req = function (url, method, params, requestHeader, fileConfig = {}) {
    ...
    let requestConfig = {
        ...
        params: Object.assign({}, params, { access_token: JSON.parse(sessionStorage.getItem('myUser')).access_token }),
        data: qs.stringify(Object.assign({}, params, { access_token: JSON.parse(sessionStorage.getItem('myUser')).access_token })),
        headers: {},
